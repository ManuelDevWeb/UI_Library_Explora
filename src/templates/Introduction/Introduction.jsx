    ...
    return (
        <div className={`row align-items-center ${styles.introduction}`}>
            ...
            <div className="col-7 overflow-hidden">
                <img src={imgPortal} className='img-fluid'/>
            </div>
        </div>
    );
}
